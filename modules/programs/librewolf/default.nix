    ...
    profiles = {
      ...
      personal = {
        ...
        settings = {
          ...
          "browser.sessionhistory.max_entries" = 20; # Limit history entries
          ...
          # VM PERFORMANCE & HARDWARE ACCELERATION OPTIMIZATIONS
          # Graphics and rendering optimizations for VMs
          "webgl.disabled" = false; # Enable WebGL for better performance
          "webgl.force-enabled" = true; # Force WebGL even in VMs
          "layers.acceleration.disabled" = false; # Enable hardware acceleration
          "gfx.webrender.enabled" = true; # Enable WebRender for better performance
          "gfx.webrender.all" = true; # Use WebRender for all content
          "layers.gpu-process.enabled" = true; # Enable GPU process
          "media.hardware-video-decoding.enabled" = true; # Hardware video decoding
          
          # Memory and JavaScript optimizations for VMs
          "javascript.options.mem.high_water_mark" = 64; # Reduce JS memory usage
          "javascript.options.mem.max" = 131072; # 128MB max JS memory
          "browser.tabs.remote.autostart" = true; # Use multiprocess
          "dom.ipc.processCount" = 2; # Limit content processes for VMs
          
          # Disable resource-intensive features for VMs
          ...
          "accessibility.force_disabled" = 1; # Disable accessibility for performance
          
          # VM-specific network optimizations
          "network.buffer.cache.size" = 65536; # 64KB network buffer
